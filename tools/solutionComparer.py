...
f1 = open("difference_first.txt", 'w')
...
f1.write("Total difference " + str(difference_first) + "\n")
f1.write("Total difference short <250bp " + str(difference_first_short) + "\n")
f1.write("True short <250bp " + str(true_first_short) + "\n")


f1.write("Total difference medium 250-1000bp " + str(difference_first_medium) + "\n")
f1.write("True medium 250-1000bp " + str(true_first_medium) + "\n")

f1.write("Total difference long >1000 bp " + str(difference_first_long) + "\n")
f1.write("True long >1000bp " + str(true_first_long) + "\n")


f2 = open("difference_second.txt", 'w')
