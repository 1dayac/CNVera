...
struct SGWalkBuilder
{
    public:
        ...
        void finishCurrentWalk(bool add = true);
...
namespace SGSearch
{
    ...
    void findAllWalks(Vertex* pX, EdgeDir initialDir,
    ...
    //Extend walk in forward direction by one vertex
    void extendWalk(SGWalk& walk, SGWalkVector& walkVector);
};
