...
IN1=/Molly/meleshko/ecoli_perfect/ecoli_R1.fastq
IN2=/Molly/meleshko/ecoli_perfect/ecoli_R2.fastq
...
BAM2DE_BIN=~/sga/src/bin/sga-bam2de.pl
ASTAT_BIN=~/sga/src/binsga-astat.py
